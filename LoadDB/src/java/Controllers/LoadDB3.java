 ...
 * @author admin
 */
public class LoadDB3 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>3.Checkbox x Radio</title>");
            ...
            for (Student st : dao.getStd()) {
                ...
                tbl += "<td>" + st.getDob() + "</td>";
                tbl += "<td>" + st.getGpa() + "</td>";
                tbl += "<td><a href='LoadDB3?type=0&id=" + st.getId() + "'>Update</a></td>";
                tbl += "<td><a href='javascript:void(0)' onclick='confirmDelete(" + st.getId() + ", \"" + st.getName() + "\", \"LoadDB3\")'>Delete</a></td>";
                tbl += "</tr>";
            }
            tbl += "</table>";
            //Gender: checkbox  ;  Department: select
            String form = "<form action='LoadDB3' method='post'>\n"
