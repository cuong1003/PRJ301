 ...
 * @author admin
 */
public class LoadDB2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>2.Combo-box x Radio</title>");
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet LoadDB2 at " + request.getContextPath() + "</h1>");
            dao.LoadStd();
            dao.LoadDept();
            ...
            for (Student st : dao.getStd()) {
                ...
                tbl += "<td>" + st.getDob() + "</td>";
                tbl += "<td>" + st.getGpa() + "</td>";
                tbl += "<td><a href='LoadDB2?type=0&id=" + st.getId() + "'>Update</a></td>";
                tbl += "<td><a href='javascript:void(0)' onclick='confirmDelete(" + st.getId() + ", \"" + st.getName() + "\", \"LoadDB2\")'>Delete</a></td>";
                tbl += "</tr>";
            }
            tbl += "</table>";
            //Gender: checkbox  ;  Department: select
            String form = "<form action='LoadDB2' method='post'>\n"
