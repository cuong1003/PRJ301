 ...
 * @author c9
 */
public class Vip04 extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Vip04</title>");
            out.println("<style>a {text-decoration:none;color:black;}</style>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Vip04 at " + request.getContextPath () + "</h1>");
            out.println("<h1>Day la VIP04</h1>");
