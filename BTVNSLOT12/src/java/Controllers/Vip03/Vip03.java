 ...
 * @author c9
 */
public class Vip03 extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Vip03</title>");  
            out.println("<style>a {text-decoration:none;color:black;}</style>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Vip03 at " + request.getContextPath () + "</h1>");
            out.println("<h1>Day la VIP03</h1>");
